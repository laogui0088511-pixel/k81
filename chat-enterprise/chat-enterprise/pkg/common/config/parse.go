...
func InitConfig(configFile string) error {
	...
	configFieldCopy(&Config.Mongo.Uri, imConfig.Mongo.Uri)
	configFieldCopy(&Config.Mongo.Address, imConfig.Mongo.Address)
	configFieldCopy(&Config.Mongo.Database, imConfig.Mongo.Database)
	configFieldCopy(&Config.Mongo.Username, imConfig.Mongo.Username)
	configFieldCopy(&Config.Mongo.Password, imConfig.Mongo.Password)
	configFieldCopy(&Config.Mongo.MaxPoolSize, imConfig.Mongo.MaxPoolSize)

	configFieldCopy(&Config.Secret, imConfig.Secret)
	configFieldCopy(&Config.TokenPolicy.Expire, imConfig.TokenPolicy.Expire)

	//rpc
	configFieldCopy(&Config.RpcRegisterName.OpenImRtcName, imConfig.RpcRegisterName.OpenImRtcName)
