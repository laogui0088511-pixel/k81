...
const (
	...
	Admin_SetInvitationCodeAllowResetPassword_FullMethodName = "/OpenIMChat.admin.admin/SetInvitationCodeAllowResetPassword"
	Admin_VerifyResetPasswordCode_FullMethodName             = "/OpenIMChat.admin.admin/VerifyResetPasswordCode"
...
type AdminClient interface {
	...
	SetInvitationCodeAllowResetPassword(ctx context.Context, in *SetInvitationCodeAllowResetPasswordReq, opts ...grpc.CallOption) (*SetInvitationCodeAllowResetPasswordResp, error)
	VerifyResetPasswordCode(ctx context.Context, in *VerifyResetPasswordCodeReq, opts ...grpc.CallOption) (*VerifyResetPasswordCodeResp, error)
...
func (c *adminClient) SetInvitationCodeAllowResetPassword(ctx context.Context, in *SetInvitationCodeAllowResetPasswordReq, opts ...grpc.CallOption) (*SetInvitationCodeAllowResetPasswordResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetInvitationCodeAllowResetPasswordResp)
	err := c.cc.Invoke(ctx, Admin_SetInvitationCodeAllowResetPassword_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) VerifyResetPasswordCode(ctx context.Context, in *VerifyResetPasswordCodeReq, opts ...grpc.CallOption) (*VerifyResetPasswordCodeResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyResetPasswordCodeResp)
	err := c.cc.Invoke(ctx, Admin_VerifyResetPasswordCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	SetInvitationCodeAllowResetPassword(context.Context, *SetInvitationCodeAllowResetPasswordReq) (*SetInvitationCodeAllowResetPasswordResp, error)
	VerifyResetPasswordCode(context.Context, *VerifyResetPasswordCodeReq) (*VerifyResetPasswordCodeResp, error)
	// User login ip limit Query Add Remove
...
func (UnimplementedAdminServer) SetInvitationCodeAllowResetPassword(context.Context, *SetInvitationCodeAllowResetPasswordReq) (*SetInvitationCodeAllowResetPasswordResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetInvitationCodeAllowResetPassword not implemented")
}
func (UnimplementedAdminServer) VerifyResetPasswordCode(context.Context, *VerifyResetPasswordCodeReq) (*VerifyResetPasswordCodeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyResetPasswordCode not implemented")
}
...
func _Admin_SetInvitationCodeAllowResetPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetInvitationCodeAllowResetPasswordReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).SetInvitationCodeAllowResetPassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Admin_SetInvitationCodeAllowResetPassword_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).SetInvitationCodeAllowResetPassword(ctx, req.(*SetInvitationCodeAllowResetPasswordReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Admin_VerifyResetPasswordCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyResetPasswordCodeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).VerifyResetPasswordCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Admin_VerifyResetPasswordCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).VerifyResetPasswordCode(ctx, req.(*VerifyResetPasswordCodeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetInvitationCodeAllowResetPassword",
			Handler:    _Admin_SetInvitationCodeAllowResetPassword_Handler,
		},
		{
			MethodName: "VerifyResetPasswordCode",
			Handler:    _Admin_VerifyResetPasswordCode_Handler,
		},
		{
